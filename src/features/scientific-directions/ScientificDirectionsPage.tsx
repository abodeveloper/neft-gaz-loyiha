...
import { getScientificData } from "./api/scientific";
import { useScientificColumns } from "./hooks/useScientificColumns";
...
export default function ScientificDirectionsPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["scientific-directions", page, debouncedSearch, filterQuery],
    queryFn: () => getScientificData(page, debouncedSearch, filterQuery),
  });

  const columns = useScientificColumns();
