...
import { getOneTestMaterial } from "./api/test-material";

const ReadingMaterialStatisticPage = () => {
  const { id } = useParams();
  ...
  const {
    ...
    queryKey: ["test-material", id],
    queryFn: () => getOneTestMaterial(id),
  });
      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="mock" className="w-full">
          ...
          <TabsContent value="mock" className="mt-6">
            {/* <StudentSpeakingMockResults /> */}
          </TabsContent>
          <TabsContent value="thematic" className="mt-6">
            {/* <StudentSpeakingThematicResults /> */}
          </TabsContent>
        </Tabs>
      </div>
    </div>
...
export default ReadingMaterialStatisticPage;
