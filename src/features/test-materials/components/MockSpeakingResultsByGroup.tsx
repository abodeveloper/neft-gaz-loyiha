...
import { useMockSpeakingResultsColumns } from "../hooks/useMockSpeakingResultsColumns";

const MockSpeakingResultsByGroup = () => {
  ...
  const columns = useMockSpeakingResultsColumns();
    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xl font-semibold">Speaking results</div>
...
export default MockSpeakingResultsByGroup;
