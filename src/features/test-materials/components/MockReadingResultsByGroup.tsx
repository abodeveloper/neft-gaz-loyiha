...
import { useMockReadingResultsColumns } from "../hooks/useMockReadingResultsColumns";

const MockReadingResultsByGroup = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["mock-reading-results", page, debouncedSearch, extraFilterQuery],
    queryFn: () =>
  ...
  const columns = useMockReadingResultsColumns();
    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xl font-semibold">Reading results</div>
...
export default MockReadingResultsByGroup;
