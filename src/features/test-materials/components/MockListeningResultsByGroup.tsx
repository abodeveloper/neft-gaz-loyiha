...
import { useMockListeningResultsColumns } from "../hooks/useMockListeningResultsColumns";

const MockListeningResultsByGroup = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["mock-listening-results", page, debouncedSearch, extraFilterQuery],
    queryFn: () =>
  ...
  const columns = useMockListeningResultsColumns();
    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xl font-semibold">Listening results</div>
...
export default MockListeningResultsByGroup;
