...
import { useMockWritingResultsColumns } from "../hooks/useMockWritingResultsColumns";

const MockWritingResultsByGroup = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["mock-writing-results", page, debouncedSearch, extraFilterQuery],
    queryFn: () =>
  ...
  const columns = useMockWritingResultsColumns();
    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xl font-semibold">Writing results</div>
...
export default MockWritingResultsByGroup;
