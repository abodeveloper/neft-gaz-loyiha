...
export function useEducationColumns(): ColumnDef<PostgraduateEducation>[] {
  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const value = localized(item, "direction");

        return (
          <div className="font-medium" title={value || undefined}>
            {value || (
              <span className="text-muted-foreground">{t("No direction")}</span>
            )}
          </div>
        );
      },
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="font-medium" title={description || undefined}>
            {description || (
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <>
          <DynamicIcon name={row.getValue("logo")} size={24} />
        </>
      ),
    },
    {
