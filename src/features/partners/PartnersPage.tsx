...
import { usePartnerColumns } from "./hooks/usePartnerColumns";
...
export default function PartnersPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["partners", debouncedSearch, filterQuery],
    queryFn: () => getPartnersData(debouncedSearch, filterQuery),
  });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div className="text-xl font-semibold">{t("Partners")}</div>
