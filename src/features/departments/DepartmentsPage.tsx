...
import { getDepartmentsData } from "./api/department";
...
export default function DepartmentsPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["departments", page, debouncedSearch, filterQuery],
    queryFn: () => getDepartmentsData(page, debouncedSearch, filterQuery),
  });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div className="text-xl font-semibold">{t("Departments")}</div>
