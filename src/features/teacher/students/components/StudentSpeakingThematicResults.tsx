...
export default function StudentSpeakingThematicResults() {
  const { id } = useParams();
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["thematic-speaking", page, debouncedSearch],
    queryFn: () =>
      getStudentResults(id, "thematic", "speaking", page, debouncedSearch),
  });
